...
% Book metadata
\title{D{a}LAT Manual }
\author[Developers]{BlueBook Descent and Landing Analysis Toolkit}
\publisher{Max Braun}
...
\par\smallcaps{https://github.com/maxxonair/BlueBook-DaLAT-3DoF}
...
The following sections discuss the basic methods used to build up the BlueBook Descend and Landing Analysis Toolkit, as well as the basic physical and mathematical principals used to derive the equations of motion. 
...
\newthought The following sections will introduce the coordinate systems used to build up this simulation tool kit. It will explain the basic principles of this systems. 

\section{Earth Centered Inertial - ECI}

The Earth Centered Intertial (ECI)

\begin{marginfigure}%
	\includegraphics[width=\linewidth]{001_ECI.png}
	\caption{Earth Centered Intertial}
	\label{fig:marginfig}
\end{marginfigure}
