...
public class AerodynamicModel {
	...
	public static AerodynamicSet getAerodynamicSet(AtmosphereSet atmosphereSet, SpaceShip spaceShip, CurrentDataSet currentDataSet) {
		...
		aerodynamicSet.setCdC(get_CdC(atmosphereSet,  aerodynamicSet,  spaceShip));                           							// Continuum flow drag coefficient [-]
		aerodynamicSet.setDragCoefficient(calcDrag(atmosphereSet, currentDataSet, aerodynamicSet, spaceShip)); 		    	// Lift coefficient                [-]
...
//	                                      Free molecular -> transitional -> Contiuum flow
	//
	//----------------------------------------------------------------------------------------------------------------------------
	public static double calcDrag(AtmosphereSet atmosphereSet, CurrentDataSet currentDataSet, AerodynamicSet aerodynamicSet, SpaceShip spaceShip)
	{
	double CD = 0;
	double CDC=get_CdC( atmosphereSet,  aerodynamicSet,  spaceShip);
...
//	               Free molecular zone   <---------------
	...
	public static double get_CdC(AtmosphereSet atmosphereSet, AerodynamicSet aerodynamicSet, SpaceShip spaceShip){
