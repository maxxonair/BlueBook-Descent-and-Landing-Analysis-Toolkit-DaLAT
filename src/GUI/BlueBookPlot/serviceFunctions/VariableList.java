...
public class VariableList {
	...
	public VariableList(JButton panel, String axis, PlotElement plotElement) {
		this.panel = panel;
		this.axisName = axis; 
    ...
    int panelHeight=25;
    mainPanel.setBackground(BlueBookPlot.getBackgroundColor());
    ...
    for(int i=0;i<variableList.size();i++) {
	    	...
	    	buttonGroup[i].setFont(BlueBookPlot.getSmallFont());
	    	buttonGroup[i].setBackground(BlueBookPlot.getBackgroundColor());
	    	buttonGroup[i].setForeground(BlueBookPlot.getLabelColor());
