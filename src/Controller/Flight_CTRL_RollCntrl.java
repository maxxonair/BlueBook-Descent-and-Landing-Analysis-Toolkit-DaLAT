...
public class Flight_CTRL_RollCntrl {
...
//-----------------------------------------------------------------------------
public Flight_CTRL_RollCntrl(int ctrl_ID, boolean ctrl_on, double ctr_init_x, double ctr_init_y, double ctr_end_x, double ctr_end_y, double rm, double elevation) {
...
public double get_maintain_horizontal_Bank_cmd() {
     CTRL_ERROR =  y_is ;     
...
public void Update_Flight_CTRL(boolean ctrl_on, CurrentDataSet currentDataSet, double ctr_init_x, double ctr_init_y, int ctrl_curve, double tvc_was, double CTRL_Thrust, boolean engine_loss_detected) {
	...
	this.y_is 		  = currentDataSet.getEulerAngle()[0][0];
